...
const RegisterDoctor = () => {
    ...
    return (
        <div className="container" style={{ maxWidth: '500px', marginTop: '4rem' }}>
            <div className="card">
                <h2 className="text-center" style={{ color: 'var(--success)', marginBottom: '2rem' }}>Doctor Registration</h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ marginTop: '1rem', width: '100%', backgroundColor: 'var(--success)' }}>Register as Doctor</button>
                </form>
            </div>
        </div>
    );
